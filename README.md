...
## 현재 포함 플랫폼
자동화 플랫폼은 아래 2개만 사용합니다.
- 사람인
- 잡코리아

LinkedIn은 당분간 **자동화 제외 / 디버그 전용**이며, 링커리어는 검색 효율이 낮아 자동화 대상에서 제외했습니다.
...
## 로그 / CSV 항목
공식/플랫폼 실행 모두 `debug_outputs/*.csv`를 남깁니다.
