...
- 헤더 구조나 정렬 규칙이 바뀐 패치 후에는 먼저 한 번 실행하는 것이 좋습니다.
...
- `debug_outputs/*.csv` 아티팩트를 업로드해, 검색된 공고명 / 제외된 공고명 / 제외 이유를 확인
...
- 제목/직무에 아래 제외 키워드가 있으면 우선 제외합니다.
  - software, firmware, IT, cloud, cybersecurity, security
  - circuit, analog, digital, rtl, verification, physical design, layout, asic, soc, fpga
  - finance, accounting, HR, legal, procurement, buyer, logistics, supply chain, sales, marketing
  - facility, facilities, maintenance, utility, utilities, ehs
