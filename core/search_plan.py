...
PLATFORM_SEARCH_TERMS = {
    ...
    "Applied Materials": ["Applied Materials", "Applied Materials Korea", "어플라이드 머티어리얼즈", "어플라이드 머티어리얼즈 코리아"],
    "KLA": ["KLA"],
    "Lam Research": ["Lam Research", "램리서치"],
    "TEL": ["TEL", "Tokyo Electron", "도쿄일렉트론"],
    "Micron": ["Micron", "Micron Technology", "마이크론"],
    "ASM": ["ASM", "ASM International"],
    "TSMC": ["TSMC", "Taiwan Semiconductor"],
    "NVIDIA": ["NVIDIA", "엔비디아"],
    "AMD": ["AMD", "Advanced Micro Devices"],
}

def get_platform_search_terms(company_name: str) -> list[str]:
    return _dedupe_keep_order(PLATFORM_SEARCH_TERMS.get(company_name, [company_name]))
