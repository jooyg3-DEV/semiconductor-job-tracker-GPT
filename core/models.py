...
from core.utils import canonicalize_job_url, infer_region_from_location
...
class JobRecord:
    ...
    def unique_key(self) -> str:
        return self.job_id.strip() or self.canonical_url.strip() or self.url.strip()
